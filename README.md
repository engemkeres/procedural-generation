This project aims to help me learn procedural generation.

My [interactive site (with GitHub Pages)](https://engemkeres.github.io/procedural-generation/) and debug environment uses TypeScript, React, Vite and three.js (renders with WebGPU). The shader code is written in [TSL](https://github.com/mrdoob/three.js/wiki/Three.js-Shading-Language/), which is a node-based shader abstraction, written in JavaScript.
...
- [Three WebGPU Renderer](https://sbcode.net/threejs/webgpu-renderer/)
- [TSL wiki](https://github.com/mrdoob/three.js/wiki/Three.js-Shading-Language)
- [three.js docs](https://threejs.org/docs/)
- [TSL docs](https://www.goodtsl.com/en/docs)

The `exercises` branch contains the TSL implementation of several exercises from [The Book of Shaders](https://thebookofshaders.com/), chapter 5-13. Examples of what I learned:
...
[<img src="https://github.com/user-attachments/assets/4322415d-1663-4bce-bb21-143f0dae0b8a" width=50% />](https://github.com/user-attachments/assets/4322415d-1663-4bce-bb21-143f0dae0b8a)
[<img src="https://github.com/user-attachments/assets/05adf36b-f400-4a73-a006-288500c8fc4a" width=50% />](https://github.com/user-attachments/assets/05adf36b-f400-4a73-a006-288500c8fc4a)
[<img src="https://github.com/user-attachments/assets/c4a71d5e-b5fc-4d7f-b6cd-7dd88f639e22" width=50% />](https://github.com/user-attachments/assets/c4a71d5e-b5fc-4d7f-b6cd-7dd88f639e22)
[<img src="https://github.com/user-attachments/assets/bf1d99a4-90a0-4817-a40d-cf4b557066ed" width=50% />](https://github.com/user-attachments/assets/bf1d99a4-90a0-4817-a40d-cf4b557066ed)
